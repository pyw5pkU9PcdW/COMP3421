...
<div class="site-travel">
    <table width = 100%>
        ...
        <tr>
            ...
            <td class = "green">
                <a  href="http://localhost/comp3421/web/index.php?r=site%2Ftravel_1">The Hong Kong Polytechnic University</a>
                <br>
        ...
        <tr>
            <td>
                <a  href="http://localhost/comp3421/web/index.php?r=site%2Ftravel_2"><img alt="Hong Kong Science Museum" title="Hong Kong Science Museum" width="250" height="147" src="/comp3421/web/../resources/travel/travel_2.jpg" border="0" /></a>
            </td>
            <td>
                <a  href="http://localhost/comp3421/web/index.php?r=site%2Ftravel_2">Hong Kong Science Museum</a>
                <br>
        ...
        <tr>
            <td>
                <a  href="http://localhost/comp3421/web/index.php?r=site%2Ftravel_3"><img alt="Hong Kong Space Museum" title="Hong Kong Space Museum" width="250" height="147" src="/comp3421/web/../resources/travel/travel_3.jpg" border="0" /></a>
            </td>
            <td class = "green">
                <a  href="http://localhost/comp3421/web/index.php?r=site%2Ftravel_3">Hong Kong Space Museum</a>
                <br>
        ...
        <tr>
            <td>
                <a  href="http://localhost/comp3421/web/index.php?r=site%2Ftravel_4"><img alt="Avenue of Stars" title="Avenue of Stars" width="250" height="147" src="/comp3421/web/../resources/travel/travel_4.jpg" border="0" /></a>
            </td>
            <td>
                <a  href="http://localhost/comp3421/web/index.php?r=site%2Ftravel_4">Avenue of Stars</a>
                <br>
        ...
        <tr>
            <td>
                <a  href="http://localhost/comp3421/web/index.php?r=site%2Ftravel_5"><img alt="iSQUARE" title="iSQUARE" width="250" height="147" src="/comp3421/web/../resources/travel/travel_5.jpg" border="0" /></a>
            </td>
            <td class = "green">
                <a  href="http://localhost/comp3421/web/index.php?r=site%2Ftravel_5">iSQUARE</a>
                <br>
        ...
        <tr>
            <td>
                <a  href="http://localhost/comp3421/web/index.php?r=site%2Ftravel_6"><img alt="Harbour Cityn" title="Harbour City" width="250" height="147" src="/comp3421/web/../resources/travel/travel_6.jpg" border="0" /></a>
            </td>
            <td>
                <a  href="http://localhost/comp3421/web/index.php?r=site%2Ftravel_6">Harbour City</a>
                <br>
